...
public abstract class Entity : IEquatable<Entity>
{
    ...
    /// </summary>
    /// <param name="now">Значение типа <see cref="DateTimeOffset"/> — текущее время, обычно в формате UTC, для установки в <see cref="UpdatedAt"/>.</param>
    protected void MarkAsUpdated(DateTimeOffset now) => UpdatedAt = now;
}
