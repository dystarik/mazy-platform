...
export type ValidateScenarioDraftRequest = components['schemas']['ValidateScenarioDraftRequest']
export type ValidateScenarioDraftResponse = components['schemas']['ValidateScenarioDraftResponse']
export type ScenarioValidationErrorItem  = components['schemas']['ScenarioValidationErrorItem']
