...
internal sealed class ChangeBotScenarioVersionValidator : AbstractValidator<ChangeBotScenarioVersionCommand>
{
    public ChangeBotScenarioVersionValidator()
    {
        ...
        RuleFor(x => x.NewScenarioVersion)
            .GreaterThan(0)
            .WithErrorCode(ErrorCodes.Validation.Invalid)
            .WithMessage("Версия сценария должна быть больше нуля.");
    }
}
