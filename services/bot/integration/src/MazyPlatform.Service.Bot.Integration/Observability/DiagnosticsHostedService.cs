    ...
    ILogger<DiagnosticsHostedService> logger) : IHostedService, IAsyncDisposable
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        builder.Services.AddHealthChecks()
            .AddCheck("self", () => HealthCheckResult.Healthy("Bot integration запущен."), tags: ["live"])
            .AddCheck("configuration", new BotIntegrationConfigurationHealthCheck(configuration, environment), tags: ["ready"]);
