    ...
    ILogger<DiagnosticsHostedService> logger) : IHostedService, IAsyncDisposable
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        builder.Services.AddHealthChecks()
            .AddCheck("self", () => HealthCheckResult.Healthy("Scenario engine запущен."), tags: ["live"])
            .AddCheck("configuration", new ScenarioEngineConfigurationHealthCheck(configuration, environment), tags: ["ready"]);
