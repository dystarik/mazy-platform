...
internal sealed class ScenarioRepositoryConfigurationHealthCheck(
    ...
    IWebHostEnvironment environment) : IHealthCheck
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return failures.Count == 0
            ? Task.FromResult(HealthCheckResult.Healthy("Конфигурация сервиса сценариев готова."))
            : Task.FromResult(HealthCheckResult.Unhealthy("Конфигурация сервиса сценариев не готова к production.", data: failures));
    }
