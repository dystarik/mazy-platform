...
internal sealed partial class DeleteEntitySchemaHandler(
    ILogger<DeleteEntitySchemaHandler> logger,
    IEntitySchemaRepository entitySchemaRepository,
    IProjectRepository projectRepository,
    TimeProvider timeProvider,
    IUnitOfWork unitOfWork) : ICommandHandler<DeleteEntitySchemaCommand>
{
    public async Task<Result> HandleAsync(DeleteEntitySchemaCommand command, CancellationToken cancellationToken = default)
    {
        ...
        schema.Delete(timeProvider.GetUtcNow());
        entitySchemaRepository.Delete(schema);
